#############################################################
#  Diagnostic plots for MCMc output- pine data (simulated)  #
#############################################################
...
c1b = rep(0.5,2),
s = c(0.8,0.8,0.8,0.8,0.8), delta=-2, sigma=7,sigma2=7)

####################
#  Mobility plots  #
####################

 s<-model.beta.pine3$mean$s
 
win.sim.mobility<-model.beta.pine3
##Trace plots##
...
for(j in 1:2)
{
ts.plot(win.sim.mobility$sims.list$m0[,i,j],ylab=expression(paste(m,"0")))
}
ts.plot(win.sim.mobility$sims.list$m1[,i],ylab=expression(paste(m,"1")))
}
for(i in 1:3)
{
ts.plot(win.sim.mobility$sims.list$m0a[,i],ylab=expression(paste(m,"0a")))
ts.plot(win.sim.mobility$sims.list$m1a[,i],ylab=expression(paste(m,"1a")))
}
for(i in 1:10)
{
for(j in 1:4)
{
ts.plot(win.sim.mobility$sims.list$m0b[,i,j],ylab=expression(paste(m,"0b")))
}
ts.plot(win.sim.mobility$sims.list$m1b[,i],ylab=expression(paste(m,"1b")))
}
for(i in 1:20)
{
for(j in 1:3)
{
ts.plot(win.sim.mobility$sims.list$m0c[,i,j],ylab=expression(paste(m,"0c")))
}
ts.plot(win.sim.mobility$sims.list$m1c[,i],ylab=expression(paste(m,"1c")))
}
dev.off()

 ##Save estimated model parameters##
 m0.mob<-win.sim.mobility$mean$m0
 m1.mob<-win.sim.mobility$mean$m1
 #
 m0a.mob<-win.sim.mobility$mean$m0a
 m1a.mob<-win.sim.mobility$mean$m1a
 #
 m0b.mob<-win.sim.mobility$mean$m0b
 m1b.mob<-win.sim.mobility$mean$m1b
 #
 m0c.mob<-win.sim.mobility$mean$m0c
 m1c.mob<-win.sim.mobility$mean$m1c
 #


dump(c("m0.mob","m1.mob","m0a.mob","m1a.mob","m0b.mob","m1b.mob","m0c.mob","m1c.mob"),file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/model parameters/betapinesim_mob.txt")
...
comb.mob.act<-list(m0=comb.sim.act$m0,m1=comb.sim.act$m1,m0a=comb.sim.act$m0a,m1a=comb.sim.act$m1a,m0b=comb.sim.act$m0b,m1b=comb.sim.act$m1b,m0c=comb.sim.act$m0c,m1c=comb.sim.act$m1c,s=comb.sim.act$s)

plot.mob.comb<-function(dat = snames,dat1 = snames)
{
#par(mfrow = c(1, 1))
 omega <- seq(-5, 5, 0.1)
 nu1 <- rnorm(1,0,1)
 theta1 <-  comb.mob.sim$s[1]*omega + sqrt(1-(comb.mob.sim$s[1]*comb.mob.sim$s[1]))*nu1
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Mobility/ICC/item%d.png",height=5,width=5,units="in",res=300)
  for(i in 1:9)
  {
    ...
    #
		...
		prob3 <- 1 - cprob2
		#
		lines(theta1, prob1, col = 2, lwd = 2,lty=2)
		lines(theta1, prob2, col = 3, lwd = 2,lty=2)
		lines(theta1, prob3, col = 4, lwd = 2,lty=2)
...
png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Mobility/ICC/item1a.png",height=5,width=5,units="in",res=300)
  for(i in 1:2)
  {
		plot(theta1, p.new, ylim = c(0, 1), main = " ", type = "n", ylab = "Probability", xlab = expression(paste(theta[1]," (Mobility)")))
		#
    ...
    dat1$m1a <- unlist(dat1$m1a)
		...
		cprob1 <- 1/(1 + exp( - (b0a.n1 + b1a.n1 * theta1)))
		#
		lines(theta1, cprob1, col = 2, lwd = 2,lty=2)
  }
	dev.off()


   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Mobility/ICC/item%db.png",height=5,width=5,units="in",res=300)
    ...
    #
		...
		lines(theta1, prob2, col = 3, lwd = 2,lty=2)
		lines(theta1, prob3, col = 4, lwd = 2,lty=2)
		lines(theta1, prob4, col = 5, lwd = 2,lty=2)
		lines(theta1, prob5, col = 6, lwd = 2,lty=2)
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Mobility/ICC/item%dc.png",height=5,width=5,units="in",res=300)
  ...
  plot.mob.comb(dat=comb.mob.sim,dat1=comb.mob.act)

 rm(win.sim.mobility)
###############
#  ADL plots  #
###############
win.sim.adl<-model.beta.pine3
##Trace plots##
png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/ADL/trace plots//item%02d.png",height=5,width=5,units="in",res=300)
par(mfrow=c(2,1))
for(i in 1:9)
{
for(j in 1:2)
{
ts.plot(win.sim.adl$sims.list$a0[,i,j],ylab=expression(paste(a,"0")))
}
ts.plot(win.sim.adl$sims.list$a1[,i],ylab=expression(paste(a,"1")))
}
for(i in 1:5)
{
ts.plot(win.sim.adl$sims.list$a0a[,i],ylab=expression(paste(a,"0a")))
ts.plot(win.sim.adl$sims.list$a1a[,i],ylab=expression(paste(a,"1a")))
}
for(i in 1:11)
{
for(j in 1:3)
{
ts.plot(win.sim.adl$sims.list$a0b[,i,j],ylab=expression(paste(a,"0b")))
}
ts.plot(win.sim.adl$sims.list$a1b[,i],ylab=expression(paste(a,"1b")))
}
for(i in 1:4)
{
for(j in 1:4)
{
ts.plot(win.sim.adl$sims.list$a0c[,i,j],ylab=expression(paste(a,"0c")))
}
ts.plot(win.sim.adl$sims.list$a1c[,i],ylab=expression(paste(a,"1c")))
}

ts.plot(win.sim.adl$sims.list$a0d,ylab=expression(paste(a,"0d")))
ts.plot(win.sim.adl$sims.list$a1d,ylab=expression(paste(a,"1d")))

dev.off()

 ##Save estimated model parameters##
 a0.adl<-win.sim.adl$mean$a0
 a1.adl<-win.sim.adl$mean$a1
 #
 a0a.adl<-win.sim.adl$mean$a0a
 a1a.adl<-win.sim.adl$mean$a1a
 #
 a0b.adl<-win.sim.adl$mean$a0b
 a1b.adl<-win.sim.adl$mean$a1b
 #
 a0c.adl<-win.sim.adl$mean$a0c
 a1c.adl<-win.sim.adl$mean$a1c
 #
 a0d.adl<-win.sim.adl$mean$a0d
 a1d.adl<-win.sim.adl$mean$a1d
 #

dump(c("a0.adl","a1.adl","a0a.adl","a1a.adl","a0b.adl","a1b.adl","a0c.adl","a1c.adl","a0d.adl","a1d.adl"),file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/model parameters/betapine3_adl.txt")
...
comb.adl.act<-list(a0=comb.sim.act$a0,a1=comb.sim.act$a1,a0a=comb.sim.act$a0a,a1a=comb.sim.act$a1a,a0b=comb.sim.act$a0b,a1b=comb.sim.act$a1b,a0c=comb.sim.act$a0c,a1c=comb.sim.act$a1c,a0d=comb.sim.act$a0d,a1d=comb.sim.act$a1d,s=comb.sim.act$s)


plot.adl.comb<-function(dat = comb.adl.sim,dat1 = comb.adl.act)
{
par(mfrow = c(1, 1))
 omega <- seq(-4, 4, 0.1)
 nu2 <- rnorm(1,0,1)
 theta2 <-  comb.adl.sim$s[2]*omega + sqrt(1-(comb.adl.sim$s[2]*comb.adl.sim$s[2]))*nu2
	...
	#
png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/ADL/ICC/item%d.png",height=5,width=5,units="in",res=300)
...
for(i in 1:9) {
  ...
  #
		...
		prob3<-1-cprob2
  #
  lines(theta2, prob1, col = 2, lwd = 2,lty=2)
  lines(theta2, prob2, col = 3, lwd = 2,lty=2)
  lines(theta2, prob3, col = 4, lwd = 2,lty=2)
   #
   #
		leg.txt <- c("0", "1", "2")
	 ...
	 png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/ADL/ICC/item%da.png",height=5,width=5,units="in",res=300)
    ...
    #
		...
		cprob1 <- 1/(1 + exp( - (b0a.n1 + b1a.n1 * theta2)))
    #
		lines(theta2, cprob1, col = 2, lwd = 2,lty=2)
    #
	}
	dev.off()


   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/ADL/ICC/item%db.png",height=5,width=5,units="in",res=300)
    ...
    #
		...
		lines(theta2, prob2, col = 3, lwd = 2,lty=2)
		lines(theta2, prob3, col = 4, lwd = 2,lty=2)
		lines(theta2, prob4, col = 5, lwd = 2,lty=2)
    #
		leg.txt <- c("0", "1", "2", "3")
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/ADL/ICC/item%dc.png",height=5,width=5,units="in",res=300)
  ...
  for(i in 1:4)
  {
    ...
    #
		...
		lines(theta2, prob3, col = 4, lwd = 2,lty=2)
		lines(theta2, prob4, col = 5, lwd = 2,lty=2)
		lines(theta2, prob5, col = 6, lwd = 2,lty=2)
		#
		leg.txt <- c("0", "1", "2", "3", "4")
		legend("topright", leg.txt, col = c(2, 3, 4, 5, 6), lwd = c(2, 2, 2, 2, 2), cex = 0.8)
  }
	 dev.off()
	  png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/ADL/ICC/item%01dd.png",height=5,width=5,units="in",res=300)
		#
  ...
  plot.adl.comb(dat=comb.adl.sim,dat1=comb.adl.act)

rm(win.sim.adl)
######################
#  Depression plots  #
######################
win.sim.depression<-model.beta.pine3
##Trace plots##
png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Depression/trace plots/item%02d.png",height=5,width=5,units="in",res=300)
par(mfrow=c(2,1))

for(j in 1:27)
{
ts.plot(win.sim.depression$sims.list$d0[,i],ylab=expression(paste(d,"0")))
ts.plot(win.sim.depression$sims.list$d1[,i],ylab=expression(paste(d,"1")))
}
...
for(j in 1:3)
{
ts.plot(win.sim.depression$sims.list$d0a[,i,j],ylab=expression(paste(d,"0a")))
}
ts.plot(win.sim.depression$sims.list$d1a[,i],ylab=expression(paste(d,"1a")))
}
for(i in 1:4)
{
ts.plot(win.sim.depression$sims.list$d0b[,i],ylab=expression(paste(d,"0b")))
}
ts.plot(win.sim.depression$sims.list$d1b,ylab=expression(paste(d,"1b")))

for(i in 1:9)
{
for(j in 1:2)
{
ts.plot(win.sim.depression$sims.list$d0c[,i,j],ylab=expression(paste(d,"0c")))
}
ts.plot(win.sim.depression$sims.list$d1c[,i],ylab=expression(paste(d,"1c")))
}
dev.off()

 ##Save estimated model parameters##
 d0.depression<-win.sim.depression$mean$d0
 d1.depression<-win.sim.depression$mean$d1
 #
 d0a.depression<-win.sim.depression$mean$d0a
 d1a.depression<-win.sim.depression$mean$d1a
 #
 d0b.depression<-win.sim.depression$mean$d0b
 d1b.depression<-win.sim.depression$mean$d1b
 #
 d0c.depression<-win.sim.depression$mean$d0c
 d1c.depression<-win.sim.depression$mean$d1c
 #

dump(c("d0.depression","d1.depression","d0a.depression","d1a.depression","d0b.depression","d1b.depression","d0c.depression","d1c.depression"),file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/model parameters/betapine3_depression.txt")
...
comb.dep.act<-list(d0=comb.sim.act$d0,d1=comb.sim.act$d1,d0a=comb.sim.act$d0a,d1a=comb.sim.act$d1a,d0b=comb.sim.act$d0b,d1b=comb.sim.act$d1b,d0c=comb.sim.act$d0c,d1c=comb.sim.act$d1c,s=comb.sim.act$s)


plot.depression.comb<-function(dat = dat,dat1=comb.dep.act)
{
par(mfrow = c(1, 1))
omega <- seq(-4, 4, 0.1)
 nu3 <- rnorm(1,0,1)
 theta3 <-  dat$s[3]*omega + sqrt(1-(dat$s[3]*dat$s[3]))*nu3
	...
	#
png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Depression/ICC/item%d.png",height=5,width=5,units="in",res=300)
for(i in 1:26)
{
    ...
    #
		...
		cprob1 <- 1/(1 + exp( - (b0.n1 + b1.n1 * theta3)))
    #
		lines(theta3, cprob1, col = 2, lwd = 2,lty=2)

}
	dev.off()

	 png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Depression/ICC/item%da.png",height=5,width=5,units="in",res=300)
    ...
    #
		...
		prob4<-1-cprob3
    #
		lines(theta3, prob1, col = 2, lwd = 2,lty=2)
		lines(theta3, prob2, col = 3, lwd = 2,lty=2)
		lines(theta3, prob3, col = 4, lwd = 2,lty=2)
		lines(theta3, prob4, col = 5, lwd = 2,lty=2)
		#
		leg.txt <- c("0", "1", "2","3")
		legend("topright", leg.txt, col = c(2, 3, 4, 5), lwd = c(2, 2, 2, 2), cex = 0.8)
    }
  ...
  png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Depression/ICC/item1b.png",height=5,width=5,units="in",res=300)
 plot(theta3, p.new, ylim=c(0,1), main =" ", type = "n", ylab = "Probability", xlab = expression(paste(theta[3]," (Depression)")))
		#
    ...
    #
		...
		lines(theta3, prob3, col = 4, lwd = 2,lty=2)
		lines(theta3, prob4, col = 5, lwd = 2,lty=2)
		lines(theta3, prob5, col = 6, lwd = 2,lty=2)
    #
    ...
    leg.txt <- c("0", "1", "2","3")
	 ...
	 dev.off()
 	 ...
 	 png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Depression/ICC/item%dc.png",height=5,width=5,units="in",res=300)
  ...
  plot.depression.comb(dat=comb.depression.sim,dat1=comb.dep.act)
...
win.sim.pain<-model.beta.pine3
##Trace plots##
png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Pain/trace plots/item%02d.png",height=5,width=5,units="in",res=300)
par(mfrow=c(2,1))

for(i in 1:2)
{
ts.plot(win.sim.pain$sims.list$p0[,i],ylab=expression(paste(p,"0")))
}
ts.plot(win.sim.pain$sims.list$p1,ylab=expression(paste(p,"1")))

for(i in 1:2)
{
for(j in 1:3)
{
ts.plot(win.sim.pain$sims.list$p0a[,i,j],ylab=expression(paste(p,"0a")))
}
ts.plot(win.sim.pain$sims.list$p1a[,i],ylab=expression(paste(p,"1a")))
}

for(j in 1:4)
{
ts.plot(win.sim.pain$sims.list$p0b[,j],ylab=expression(paste(p,"0b")))
}
ts.plot(win.sim.pain$sims.list$p1b,ylab=expression(paste(p,"1b")))

ts.plot(win.sim.pain$sims.list$p0c,ylab=expression(paste(p,"0c")))
ts.plot(win.sim.pain$sims.list$p1c,ylab=expression(paste(p,"1c")))

for(j in 1:6)
{
ts.plot(win.sim.pain$sims.list$p0d[,j],ylab=expression(paste(p,"0d")))
}
ts.plot(win.sim.pain$sims.list$p1d,ylab=expression(paste(p,"1d")))

ts.plot(win.sim.pain$sims.list$p0f,ylab=expression(paste(p,"0f")))
ts.plot(win.sim.pain$sims.list$p1f,ylab=expression(paste(p,"1f")))

dev.off()

 ##Save estimated model parameters##
 p0.pain<-win.sim.pain$mean$p0
 p1.pain<-win.sim.pain$mean$p1
 #
 p0a.pain<-win.sim.pain$mean$p0a
 p1a.pain<-win.sim.pain$mean$p1a
 #
 p0b.pain<-win.sim.pain$mean$p0b
 p1b.pain<-win.sim.pain$mean$p1b
 #
 p0c.pain<-win.sim.pain$mean$p0c
 p1c.pain<-win.sim.pain$mean$p1c
 #
 p0d.pain<-win.sim.pain$mean$p0d
 p1d.pain<-win.sim.pain$mean$p1d
 #
 p0f.pain<-win.sim.pain$mean$p0f
 p1f.pain<-win.sim.pain$mean$p1f
 #

dump(c("p0.pain","p1.pain","p0a.pain","p1a.pain","p0b.pain","p1b.pain","p0c.pain","p1c.pain","p0d.pain","p1d.pain","p0f.pain","p1f.pain"),file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/model parameters/betapine3_pain.txt")
...
comb.pain.act<-list(p0=comb.sim.act$p0,p1=comb.sim.act$p1,p0a=comb.sim.act$p0a,p1a=comb.sim.act$p1a,p0b=comb.sim.act$p0b,p1b=comb.sim.act$p1b,p0c=comb.sim.act$p0c,p1c=comb.sim.act$p1c,p0d=comb.sim.act$p0d,p1d=comb.sim.act$p1d,s=comb.sim.act$s)

plot.pain.comb<-function(dat = comb.pain.sim, dat1 = comb.pain.act)
{
par(mfrow = c(1, 1))
  omega <- seq(-5, 5, 0.1)
 nu4 <- rnorm(1,0,1)
...
png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Pain/ICC/item%d.png",height=5,width=5,units="in",res=300)
    ...
    #
		...
		prob3 <- 1 - cprob2
		#
		lines(theta4, prob1, col = 2, lwd = 2, lty=2)
		lines(theta4, prob2, col = 3, lwd = 2, lty=2)
		lines(theta4, prob3, col = 4, lwd = 2, lty=2)
		#
		leg.txt <- c("0", "1", "2")
		legend("topright", leg.txt, col = c(2, 3, 4), lwd = c(2, 2, 2), cex = 0.8)
  ...
  png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Pain/ICC/item%da.png",height=5,width=5,units="in",res=300)
  for(i in 1:2)
  {
		plot(theta4, p.new, ylim = c(0, 1), main = " ", type = "n", ylab = "Probability", xlab =expression(paste(theta[4]," (Pain)")))
		#
    ...
    #
		...
		lines(theta4, prob2, col = 3, lwd = 2,lty=2)
		lines(theta4, prob3, col = 4, lwd = 2,lty=2)
		lines(theta4, prob4, col = 5, lwd = 2,lty=2)
		#
		#
		leg.txt <- c("0", "1", "2")
		legend("topright", leg.txt, col = c(2, 3, 4, 5), lwd = c(2, 2, 2, 2), cex = 0.8)
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Pain/ICC/item1b.png",height=5,width=5,units="in",res=300)
    ...
    b0b.n1 <- dat1$p0b[1]
		...
		lines(theta4, prob3, col = 4, lwd = 2,lty=2)
		lines(theta4, prob4, col = 5, lwd = 2,lty=2)
		lines(theta4, prob5, col = 6, lwd = 2,lty=2)
    #
		leg.txt <- c("0", "1", "2", "3", "4")
		legend("topright", leg.txt, col = c(2, 3, 4, 5, 6), lwd = c(2, 2, 2, 2, 2), cex = 0.8)
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Pain/ICC/item1c.png",height=5,width=5,units="in",res=300)
    ...
    #
		...
		lines(theta4, cprob1, col = 2, lwd = 2, lty = 2)

	dev.off()

     png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Pain/ICC/item1d.png",height=5,width=5,units="in",res=300)
    ...
    #
		...
		lines(theta4, prob4, col = 5, lwd = 2, lty=2)
		lines(theta4, prob5, col = 6, lwd = 2, lty=2)
		lines(theta4, prob6, col = 7, lwd = 2, lty=2)
		lines(theta4, prob7, col = 8, lwd = 2, lty=2)
    #
    #
...
#    png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Pain/ICC/item1f.png",height=5,width=5,units="in",res=300)
#    #
#		#
...
#	  #
  ...
  plot.pain.comb(dat=comb.pain.sim,dat1=comb.pain.act)

rm(win.sim.pain)
#####################
#  Cognition plots  #
#####################
win.sim.cognition1<-model.beta.pine3
##Trace plots##
png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Cognition/trace plots//item%02d.png",height=5,width=5,units="in",res=300)
par(mfrow=c(2,1))

for(j in 1:24)
{
ts.plot(win.sim.cognition1$sims.list$c0[,j],ylab=expression(paste(c,"0")))
ts.plot(win.sim.cognition1$sims.list$c1[,j],ylab=expression(paste(c,"1")))
}
for(i in 1:8)
{
for(j in 1:3)
{
ts.plot(win.sim.cognition1$sims.list$c0a[,i,j],ylab=expression(paste(c,"0a")))
}
ts.plot(win.sim.cognition1$sims.list$c1a[,i],ylab=expression(paste(c,"1a")))
}
...
for(j in 1:2)
{
ts.plot(win.sim.cognition1$sims.list$c0b[,i,j],ylab=expression(paste(c,"0b")))
}
ts.plot(win.sim.cognition1$sims.list$c1b[,i],ylab=expression(paste(c,"1b")))
}

dev.off()

 ##Save estimated model parameters##
 c0.cognition<-win.sim.cognition1$mean$c0
 c1.cognition<-win.sim.cognition1$mean$c1
 #
 c0a.cognition<-win.sim.cognition1$mean$c0a
 c1a.cognition<-win.sim.cognition1$mean$c1a
 #
 c0b.cognition<-win.sim.cognition1$mean$c0b
 c1b.cognition<-win.sim.cognition1$mean$c1b
 #

dump(c("c0.cognition","c1.cognition","c0a.cognition","c1a.cognition","c0b.cognition","c1b.cognition"),file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/model parameters/betapine3_cognition.txt")
...
comb.cog.act<-list(c0=comb.sim.act$c0,c1=comb.sim.act$c1,c0a=comb.sim.act$c0a,c1a=comb.sim.act$c1a,c0b=comb.sim.act$c0b,c1b=comb.sim.act$c1b,s=comb.sim.act$s)

plot.cognition.comb<-function(dat = snames,dat1 = snames)
{
par(mfrow = c(1, 1))
omega <- seq(-4, 4, 0.1)
 nu5 <- rnorm(1,0,1)
 theta5 <-  comb.cognition.sim$s[5]*omega + sqrt(1-(comb.cognition.sim$s[5]*comb.cognition.sim$s[5]))*nu5
	...
	#
	 ...
	 png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Cognition/ICC/item%d.png",height=5,width=5,units="in",res=300)
    ...
    for(i in 1:24)
    {
		...
		#
		dat1$c1 <- unlist(dat1$c1)
		#
		b0.n1 <- dat1$c0[i]
		b1.n1 <- dat1$c1[i]
		#
		prob1 <- 1/(1 + exp( - (b0.n1 + b1.n1 * theta5)))
		lines(theta5, prob1, col = 2, lwd = 2, lty=2)
    }
	 dev.off()

   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Cognition/ICC/item1a.png",height=5,width=5,units="in",res=300)
  for(i in 1:8)
  {
		plot(theta5, p.new, ylim = c(0, 1), main = " ", type = "n", ylab = "Probability", xlab = expression(paste(theta[5]," (Cognition)")))
		#
    ...
    #
		...
		#
		lines(theta5, prob1, col = 2, lwd = 2, lty=2)
		lines(theta5, prob2, col = 3, lwd = 2, lty=2)
		lines(theta5, prob3, col = 4, lwd = 2, lty=2)
		lines(theta5, prob4, col = 5, lwd = 2, lty=2)
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Cognition/ICC/item%db.png",height=5,width=5,units="in",res=300)
  ...
  plot.cognition.comb(dat=comb.cognition.sim,dat1=comb.cog.act)

## trace plots for omega and theta traits ##
par(mfrow=c(2,1))
for(j in 1:483)
{
ts.plot(win.sim.cognition1$sims.list$omega[,j],ylab=expression(paste(omega," ",i)))
}
...
#par(mfrow = c(1, 1))
 ...
 theta1 <-  comb.mob.sim$s[1]*omega + sqrt(1-(comb.mob.sim$s[1]*comb.mob.sim$s[1]))*nu1
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Mobility/IIC/item%d.png",height=5,width=5,units="in",res=300)
  for(i in 1:8)
  {
		#
		dat$m1 <- unlist(dat$m1)
...
png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Mobility/IIC/item1a.png",height=5,width=5,units="in",res=300)
  ...
  for(i in 1:2)
  {
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Mobility/IIC/item%db.png",height=5,width=5,units="in",res=300)
...
-(-resp5*b1b.n4^2*p4*(1-p4))*(1-p4)
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Mobility/IIC/item%dc.png",height=5,width=5,units="in",res=300)
...
par(mfrow = c(1, 1))
 ...
 theta2 <-  comb.adl.sim$s[2]*omega + sqrt(1-(comb.adl.sim$s[2]*comb.adl.sim$s[2]))*nu2
	...
	#
png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/ADL/IIC/item%d.png",height=5,width=5,units="in",res=300)
...
-(-resp3*b1.n2^2*p2*(1-p2))*(1-p2)
  ...
  #
    leg.txt <- c("0", "1", "2", "total")
	 ...
	 png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/ADL/IIC/item%da.png",height=5,width=5,units="in",res=300)
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/ADL/IIC/item%db.png",height=5,width=5,units="in",res=300)
...
-(-resp4*b1b.n3^2*p3*(1-p3))*(1-p3)
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/ADL/IIC/item%dc.png",height=5,width=5,units="in",res=300)
...
omega <- seq(-4, 4, 0.1)
 ...
 theta3 <-  dat$s[3]*omega + sqrt(1-(dat$s[3]*dat$s[3]))*nu3
	p.new <- runif(length(theta3), 0, 1)
	#
png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Depression/IIC/item%d.png",height=5,width=5,units="in",res=300)
for(i in 1:26)
{
		#
		dat$d1 <- unlist(dat$d1)
	...
	dev.off()
	 ...
	 png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Depression/IIC/item%da.png",height=5,width=5,units="in",res=300)
...
-(-resp4*b1a.n3^2*p3*(1-p3))*(1-p3)
  ...
  png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Depression/IIC/item1b.png",height=5,width=5,units="in",res=300)
...
-(-resp5*b1b.n4^2*p4*(1-p4))*(1-p4)
    ...
    leg.txt <- c("1", "2","3", "4", "5", "total")
	 ...
	 dev.off()
 	 ...
 	 png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Depression/IIC/item%dc.png",height=5,width=5,units="in",res=300)
...
png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Pain/IIC/item%d.png",height=5,width=5,units="in",res=300)
...
-(-resp3*b1.n2^2*p2*(1-p2))*(1-p2)
  ...
  png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Pain/IIC/item%da.png",height=5,width=5,units="in",res=300)
  for(i in 1:2)
  {
		#
		dat$p1a <- unlist(dat$p1a)
...
-(-resp4*b1a.n3^2*p3*(1-p3))*(1-p3)
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Pain/IIC/item1b.png",height=5,width=5,units="in",res=300)
...
-(-resp5*b1b.n4^2*p4*(1-p4))*(1-p4)
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Pain/IIC/item1c.png",height=5,width=5,units="in",res=300)
		#
		#dat$d1c <- unlist(dat$d1c)
		#
		b0c.n1 <- dat$p0c
	...
	dev.off()
     ...
     png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Pain/IIC/item1d.png",height=5,width=5,units="in",res=300)
		#
		dat$p1d <- unlist(dat$p1d)
		#
		b0d.n1 <- dat$p0d[1]
...
omega <- seq(-4, 4, 0.1)
 ...
 theta5 <-  comb.cognition.sim$s[5]*omega + sqrt(1-(comb.cognition.sim$s[5]*comb.cognition.sim$s[5]))*nu5
	 ...
	 png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Cognition/IIC/item%d.png",height=5,width=5,units="in",res=300)
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Cognition/IIC/item1a.png",height=5,width=5,units="in",res=300)
  for(i in 1:8)
  {
		#
		dat$c1a <- unlist(dat$c1a)
...
-(-resp4*b1a.n3^2*p3*(1-p3))*(1-p3)
   ...
   png(file="c:/Documents and Settings/p1thompson/Desktop/work/graphics baseline/Simulated/Cognition/IIC/item%db.png",height=5,width=5,units="in",res=300)
